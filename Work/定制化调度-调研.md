...
- 如何定义场景
	- 基于场景的动态分析 Scenario-Aware Program Specialization for Timing Predictability
	- 动态任务感知 Kernel mechanisms with dynamic task-aware scheduling to reduce resource contention in NUMA multi-core systems
如何实现动态 
