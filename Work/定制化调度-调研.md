...
# update 0419
[[User-driven Online Kernel Fusion for SYCL#^add5e3|这篇]]文章介绍了一些用户驱动的内核融合相关工作
[[Supporting autonomic computing functionality via dynamic operating system kernel aspects#^2e2f18|这篇]]文章介绍了一些